...
namespace MvcMovie.Controllers
{
    public class HeThongPhanPhoiController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaHTPP,TenHTPP,PersonId,FullName,Address")] HeThongPhanPhoi heThongPhanPhoi)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaHTPP,TenHTPP,PersonId,FullName,Address")] HeThongPhanPhoi heThongPhanPhoi)
        {
            if (id != heThongPhanPhoi.PersonId)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!HeThongPhanPhoiExists(heThongPhanPhoi.PersonId))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.HeThongPhanPhoi.Any(e => e.PersonId == id);
        }
    }
}
