...
3. Đánh giá kết quả học phần
   - Thi điểm A: Vấn đáp (thực hành và hỏi trực tiếp bài thực hành)
   - Điểm B: Dựa vào điểm thi + Bài thực hành + Bài kiểm tra
   - Điểm C: Điểm danh + Làm bài thực hành
4. BÀI THỰC HÀNH SỐ 1: tạo dự án MVC đầu tiên và đẩy lên github
   - Tạo dự án .Net Mvc: dotnet new mvc -o PROJECT_NAME